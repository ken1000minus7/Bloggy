...
export const BlogCard = ({blog}) => {
    return (
        <Link to={`/blog/${blog.id}`} className="blogCard flex flex-col m-[20px] shadow-md text-start bg-[#e7f4ff] hover:bg-gray-50 duration-[400ms] hover:shadow-lg rounded-[20px]">
            ...
            <div className="blogCardAuthor flex flex-row bg-amber-100 p-[10px] group-hover:bg-white rounded-b-[20px] md:text-[12px]">
