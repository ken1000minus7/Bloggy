    ...
    <Fade triggerOnce cascade className="blog flex flex-col my-[10px] items-center">
      ...
      <MarkdownText className="text-[18px] text-start my-[10px] text-left w-[100%] px-[20px] md:text-[15px]">{blog.content} 
...

          {
              ...
              <button onClick={handleDelete} type="button" className="border border-red-700 hover:bg-red-400 rounded-md p-2.5  inline-flex items-center hover:text-white hover:scale-[1.05] hover:duration-200">
