      ...
      <div className="flex flex-row shadow-md lg:flex-col-reverse lg:pb-[20px]">
        <div className="basis-[50%] flex flex-col items-center justify-center">
          <Fade cascade triggerOnce>
            <div className="font-extrabold text-[38px] ml-[30px] my-[20px] sm:text-[25px] md:text-center md:mx-[10px] font-SourceSansPro">
            ...
            >
              <div className="font-itim">Create a blog</div>
            </Button>
          </Fade>
        </div>
        <Lottie
