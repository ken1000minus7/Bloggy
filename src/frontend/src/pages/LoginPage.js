...
export const LoginPage = () => {
    ...
    return (
        <div>
            <div className="font-bold font-itim text-[45px] m-[20px] text-center md:text-[30px] md:mx-[10px]">
                Begin your blogging journey with{" "}
                <span className="font-itim font-extrabold text-[50px] md:text-[35px]">
                    Bloggy
                </span>
            </div>
